...
def load_model(num_frames=8, model_dir="/home/argha/github/HumanPoseTracking_SNN/data/pretrained_model/model_snn_8steps.pth"):
...
def test(num_frames=8, model_dir="/home/argha/github/HumanPoseTracking_SNN/data/pretrained_model/model_snn_8steps.pth"):
    model = load_model(num_frames=num_frames, model_dir=model_dir)
    device = torch.device("cuda")
    mv_iterator = EventsIterator(input_path="/home/argha/Documents/github/openeb/sdk/modules/core/python/samples/metavision_raw_to_csv/recording_231120_071008.raw", 
    ...
    with torch.set_grad_enabled(False):
        out = model(samples.float().to(device))  # [B, T, C, H, W]
        functional.reset_net(model)
        print(out)
